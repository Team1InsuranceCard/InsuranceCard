...
public class CompensationHis extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        ArrayList<Compensation> compensations = db.searchCompensationHis(acc.getId(), pageSize, page, search);
        
        int count = db.getTotalCustomerCompensation(acc.getId(), search);
