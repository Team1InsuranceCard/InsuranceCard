        ...
        <script>
            function createPagger(url, div, before, pageIndex, after, gap, totalPage) {
                ...
                if (totalPage > 1) {
                    ...
                    if (pageIndex - gap > 1) {
                        container.innerHTML += '<li class="paging__item"><a class="paging__link" href="' + url + '?page=1">1</a></li>'
                    ...
                    if (pageIndex + gap < totalPage) {
                        container.innerHTML += '<li class="paging__item"><span class="paging__icon  paging__icon--disabled">. . .</span></li>'
                                + '<li class="paging__item"><a class="paging__link" href="' + url + '?page=1">' + totalPage + '</a></li>';
                    }
