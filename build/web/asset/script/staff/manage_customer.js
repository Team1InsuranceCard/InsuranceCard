...
function createPagger(div, pageIndex, gap, totalPages) {
    ...
    if (container != null) {
        container.innerHTML += "<a id='firstPagger' class='pagger__link' href='staff/customer/view?page=1'><span class='material-icons'>first_page</span></a>";
        container.innerHTML += "<a id='prevPagger' class='pagger__link' href='staff/customer/view?page=" + prevPage + "'><span class='material-icons'>chevron_left</span></a>";
        if (pageIndex <= 1) {
...
//            document.getElementById("prevPagger").classList.add("pagger__link--disable");
        ...
        for (var i = pageIndex - gap; i < pageIndex; i++) {
            if (i > 0) {
                container.innerHTML += "<a class='pagger__link' href='staff/customer/view?page=" + i + "'>" + i + "</a>";
            }
        }
        ...
        container.innerHTML += "<a id='nextPagger' class='pagger__link' href='staff/customer/view?page=" + nextPage + "'><span class='material-icons'>chevron_right</span></i></a>";
        container.innerHTML += "<a id='lastPagger' class='pagger__link' href='staff/customer/view?page=" + totalPages + "'><span class='material-icons'>last_page</span></i></a>";
